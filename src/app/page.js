...
export default function Home() {
    return (
        <>
            <Hero/>
            <Carte Name={"Jak vyplnit ružovej papír"} Image= {"/CarteObrazky/ruzovejpapir.png"} Url={"https://forms.gle/LTxMtpbreAKNXdKj9"} Text={"K vyplnění růžového daňového přiznání pro fyzické osoby v České  republice je nezbytné poskytnout přesné osobní a finanční informace.\n" +
